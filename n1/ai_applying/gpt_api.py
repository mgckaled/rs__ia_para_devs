...
It uses the OpenAI client to generate text completions.
"""

from openai import OpenAI

# Chave de API foi configurada via variavel de ambiente
# utilize o comando recomendado pela tutorial da OPENAI
